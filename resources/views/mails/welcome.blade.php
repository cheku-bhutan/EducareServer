                ...
                <td class="container" width="600"
                    ...
                    <div class="content"
                            ...
                            <tr style="font-family: 'Roboto', sans-serif; font-size: 14px; margin: 0;">
                                <td class="content-wrap"
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr><td></td></tr>
                                        <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <td class="content-block" style="font-family: 'Roboto', sans-serif; color: #878a99; box-sizing: border-box; line-height: 1.5; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 10px; text-align: center;" valign="top" >
                                                Thank You
                                            </td>
                                        </tr>
                                        <tr><td></td></tr>
                                        <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <td class="content-block"
                                                ...
                                                valign="top">
                                                If you received this email by mistake, simply delete it. If you are not the intended or authorized recipient, you must not use, copy, disclose or take any action based on this message or any information contained therein.
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <div style="text-align: center; margin: 10px 0px auto;">
                            <p style="font-family: 'Roboto', sans-serif; font-size: 14px;color: #98a6ad; margin:
                            0px;">{{date('Y')}} eSakor. Design & Develop by <a
